Using deep neural networks and convolutional neural networks to classify traffic signs.
Model created basing on [German Traffic Sign Dataset](http://benchmark.ini.rub.de/?section=gtsrb&subsection=dataset).
